...
metadata:
  hermes:
    category: meta
    tags: [skills, grading, evaluation, transcripts, report, self-improvement]
---
# skill-doctor

> Vendored from [warpdotdev/common-skills](https://github.com/warpdotdev/common-skills/tree/main/.agents/skills/skill-doctor)
> (MIT, see `LICENSE.upstream`) at commit `f589e22`, 2026-08-28. Only the frontmatter
> (`version` / `metadata.hermes`) and this note were added.
